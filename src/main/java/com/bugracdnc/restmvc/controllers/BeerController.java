...
public class BeerController {
    ...
    public ResponseEntity<HttpStatus> updateById(@PathVariable("beerId") UUID beerId, @RequestBody BeerDTO beerDTO) {
    ...
    public ResponseEntity<HttpStatus> handlePost(@RequestBody BeerDTO beerDTO) {
